...
module.exports = class MonsterGame {
  ...
  // List monsters
  listMonsters = () => {
  monsterList.forEach(element => console.log(`Monster: ${element.monsterName}, Minimum Life: ${element.minimumLife}, Current Life: ${element.currentLife}, Status: ${element.isAlive}`));
  };
